...
<head>
    ...
    <link rel='stylesheet' href='css/photos.css' media='all'>
...
<div class="overview">
    <article v-for="(photo, index) in photos" :class="active[index] ? '' : 'removed'">
        ...
        <h3>{{ photo.title }}<input type='image' src='/img/icons/60.png' alt='Edit' v-if='isAuthor && active[index]' @click='edit(index)'><input type='image' src='/img/icons/19.png' alt='Delete' v-if='isAuthor && active[index]' @click='del(index)'></h3>
